// Package authz provides secure authentication and authorization services using JWT tokens.
...
// Common error variables for authz
var (
	ErrNotAuthorized           = errors.New("authz: not authorized")
	ErrTokenExpired            = errors.New("authz: token has expired")
	ErrIssuedAtMissing         = errors.New("authz: issued at claim is missing")
	ErrIssuedAtInFuture        = errors.New("authz: token is malformed: issued-at time is in the future")
	ErrIdentityMissing         = errors.New("authz: identity claim is missing")
	ErrInvalidTokenClaims      = errors.New("authz: invalid token claims")
	ErrTokenMissing            = errors.New("authz: token is missing")
	ErrUnexpectedSigningMethod = errors.New("authz: unexpected signing method")
	ErrTokenParsingFailed      = errors.New("authz: token parsing failed")
	ErrTokenSigningFailed      = errors.New("authz: token signing failed")
	ErrEmptyJWTSecret          = errors.New("authz: JWT secret cannot be empty")
	ErrEmptyIdentity           = errors.New("authz: identity cannot be empty")
)
